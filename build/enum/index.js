...
var _default = {
  ...
  log: {
    type: {
      ...
      'RECEIVE', 'RETURN', 'CREATE_SHARING', 'CANCEL_SHARING', 'CONFIRM_SHARING', // for lease
  ...
  logTitle: {
    type: {
      ENUM: [// lease
      'Create lease request', 'Request decline by hub', 'Request accepted by hub', 'Placing car at hub', 'Renting', 'Take car at hub', 'Rented by someone', // rental
      'Create rental request', 'Take car at hub', 'Request sharing car', 'Cancel sharing car', 'Confirm sharing car', 'Return car', 'Pay extra overdue value']
    }
  }
};
