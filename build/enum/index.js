...
var _default = {
  ...
  logTitle: {
    type: {
      ENUM: [// lease
      'Create lease request', 'Request decline by hub', 'Request accepted by hub', 'Placing car at hub', 'Renting', 'Take car at hub', 'Rented by someone', 'Request take car back', 'Hub rejects to receive car', // rental
      'Create rental request', 'Booking request decline', 'Take car at hub', 'Request sharing car', 'Cancel sharing car', 'Confirm sharing car', 'Return car', 'Pay extra overdue value', 'User cancel request', 'Not accept taking car']
    }
  }
};
