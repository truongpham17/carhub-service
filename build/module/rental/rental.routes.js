...
routes.patch('/transaction/:id', _passport.auth, _rental.submitTransaction);
routes.patch('/:id', _passport.auth, _rental.updateRental);
routes.patch('/cancelSharing/:id', _passport.auth, _rental.cancelSharing);
