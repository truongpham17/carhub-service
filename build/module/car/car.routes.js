...
routes.get('/checkAvailableCar/:id/:rentalId', _passport.auth, _car.checkAvailableCarForRental); // routes.post('/', auth, validate(carValidations.createCar), createCar);

routes.post('/', _passport.auth, _car.createCar);
routes.post('/createLeasingCar', _passport.auth, _car.createLeasingCar);
